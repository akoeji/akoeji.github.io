...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="#">Anshar Priwarsani</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="btn btn-primary tombol" href="#">Subscribe</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <section class="testimonial">
            <div class="row justify-content-center">
                <div class="col-8">
                    <h5 class="testi1">"Bekerja dengan suasana hati yang lebih asik dan mempelajari hal baru setiap
                        hari."</h5>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-8 justify-content-center d-flex">
                    <figure class="figure">
                        <img src="img/img1.png" class="figure-img img-fluid rounded-circle" alt="testimonial 1">
                    </figure>
                    <figure class="figure">
                        <img src="img/img2.png" class="figure-img img-fluid rounded-circle utama" alt="testimonial 2">
                    ...
                    <figure class="figure">
                        <img src="img/img3.png" class="figure-img img-fluid rounded-circle" alt="testimonial 3">
                    </figure>
                </div>
            </div>
        </section>
        ...
        <footer>
            <div class="row">
                <div class="col text-center">
                    <p>2021 All Right Reserved by Anshar Priwarsani</p>
                </div>
            </div>
        </footer>
        <!-- Akhir Footer -->
